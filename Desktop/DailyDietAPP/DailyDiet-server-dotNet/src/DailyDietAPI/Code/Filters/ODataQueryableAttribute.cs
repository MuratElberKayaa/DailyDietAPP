...
namespace DailyDietAPI.Code.Filters
{
    public class ODataQueryableAttribute : EnableQueryAttribute
    {
        ...
        */
        ...
        {
            if (context.ActionArguments.ContainsKey("queryOptions"))
            {
                var queryOptions = context.ActionArguments["queryOptions"] as ODataQueryOptions;
